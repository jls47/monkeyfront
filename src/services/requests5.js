...
class music5{
	static createSongs(form){
		...
		return axios.post(`https://monkeyback5.herokuapp.com/api/songs/`,{data: form})
		  .then(response => {
		  	return response;
		  })
		  .catch(e => {
	...
	static getRecentSongs(){
		...
		return axios.get(`https://monkeyback5.herokuapp.com/api/songs/r/`)
			.then(response => {
				this.songs = response;
	...
	static getSongsByArtist(artist){
		...
		return axios.get(`https://monkeyback5.herokuapp.com/api/songs/a/`+artist)
			.then(response => {
				this.songs = response;
				return this.songs.data;
			})
	...
	static searchSongs(term){
		...
		return axios.get(`https://monkeyback5.herokuapp.com/api/songs/s/`+term)
			.then(response => {
				this.songs = response;
				return this.songs.data;
			})
	...
	static editSongs(form){
		...
		return axios.put(`https://monkeyback5.herokuapp.com/api/songs/`, form)
			.then(response => {
				this.res = response;
				return this.res;
			})
	...
	static searchArtist(term){
		...
		return axios.get(`https://monkeyback5.herokuapp.com/api/artists/s/`+term)
			.then(response => {
	...
	static deleteSongs(data){
		...
		return axios.delete(`https://monkeyback5.herokuapp.com/api/songs/` + data)
			.then(response => {
				return response;
			})
			.catch(e => {
	...
	static adminLog(data){
		...
		return axios.get(`https://monkeyback5.herokuapp.com/api/user`, {
			params: {
				name: data.username,
